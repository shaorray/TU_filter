...
Usage:
  ...
  - alternative to HOMMER's [GRO-seq analysis](http://homer.ucsd.edu/homer/ngs/groseq/groseq.html), with mRNA TU merging.
...
Non-coding TUs will named according to their relative location to the neighbored genes.
